...
# Load the labels
# class_names = open("labels.txt", "r").readlines() # wrong :>
class_names = open("labels.txt", "r", encoding="utf-8").readlines()
# class_names = ["Không khẩu trang", "Đeo khẩu trang", "Không có người"]

# # CAMERA can be 0 or 1 based on default camera of your computer
camera = cv2.VideoCapture("http://192.168.100.19:81/stream")

# droidcam -> phone
# DroidCam Client -> laptop -> same wifi

def image_detector():   # pass index here if need
    # # for detect from many camera
